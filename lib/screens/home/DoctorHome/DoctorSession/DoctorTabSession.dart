...
import 'package:hiappy/screens/home/DoctorHome/DoctorAllSession/DoctorAllSession.dart';
...
class DoctorTabSession extends StatelessWidget {
  const DoctorTabSession({super.key});
          ...
          children: [
            ...
            Padding(
              ...
              onSeeMore: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => DoctorAllSession(),
                  ),
                );
              },
              meeting: meeting,
